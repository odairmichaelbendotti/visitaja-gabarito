...
export default function SignupPage() {
  return (
    <div className="flex h-dvh flex-col lg:flex-row">
      ...
      <div className="relative hidden shrink-0 flex-col justify-between overflow-hidden bg-brand p-16 text-on-brand lg:flex lg:w-1/2">
        ...
        <div className="relative flex flex-col gap-6">
          ...
          <p className="max-w-130 text-body-l text-on-brand/80">
            Comece a receber agendamentos de visita pelo link do imóvel. Sem
            instalar nada.
          </p>
        </div>
      ...
      {/* Form */}
      <div className="flex min-h-0 flex-1 flex-col items-center gap-8 overflow-y-auto bg-surface p-6 py-12 lg:p-16">
